...
import { createAccount, deleteAccount, openDemo, setPin, signIn, useAccounts, type Account } from "../lib/accounts";
      ...
      <div className="welcome">
        ...
        {view.kind === "list" && (
          <>
            ...
            <p className="xs faint" style={{ marginTop: 18 }}>Profiles are saved in this browser on this computer only.</p>
          </>
        )}
